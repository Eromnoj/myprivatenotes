  ...
  group('Mock Authentication', () {
    ...
    test('Create user should delegate to logIn', () async {
      ...
      expect(badPasswordUser,
          throwsA(const TypeMatcher<WrongPassordAuthException>()));
    ...
    test('Should be able to log out ans log in again', () async {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    if (password == 'foobar') throw WrongPassordAuthException();
    const user = AuthUser(
      id: 'my_id',
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(
      ...
      email: 'foo@notbar.com',
    );
    _user = newUser;
  }

  @override
  Future<void> sendPasword({required String toEmail}) {
    // TODO: implement sendPasword
